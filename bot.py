...
class WipeGorevView(discord.ui.View):
    ...
    def get_embed(self, guild_name):
        ...
        kanal_etiket = "<#1546896143861153882>"
        desc = (
...
async def dmgonder_komutu(ctx, *, duyuru_metni: str = "MAZARETLİ KABUL EDİLMİYECEKTİR TIKLE"):
    ...
    for member in rol.members:
        ...
        try:
            ...
            dm_embed.add_field(name="Duyuru", value=f"VNT community › <#1546896143861153882> | **{duyuru_metni}**\n\n@here", inline=False)
